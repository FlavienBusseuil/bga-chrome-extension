...
export const gamesWithRecommendedConfig: { [gameName: GameName]: RecommendedConfig } = {
	...
	grovesolitaire: { color: 110, sat: 20 },
	...
	lestoitsdeparis: { color: 0, sat: 20 },
	libertaliawindsofgalecrest: { color: 245, sat: 15 },
	...
	wondrouscreatures: { color: 200, sat: 20 },
};