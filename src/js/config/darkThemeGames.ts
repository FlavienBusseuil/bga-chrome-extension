...
.infopanel .title { background-color: var(--dark-20); }
.player-zoom-controls, .arboretum-row { background-color: #00660087; }
.player-zoom-controls button { filter: invert(0.8); }
[style^="--player-color: #982fffaa"] { --player-color: #b365ffaa!important; }
[style^="--player-color: #ff0000aa"] { --player-color: #ff6565aa!important; }
[style^="--player-color: #0000ffaa"] { --player-color: #6565ffaa!important; }
[style^="--player-color: #008000aa"] { --player-color: #54aa54aa!important; }
[style^="--player-color: #ffa500aa"] { --player-color: #ffc965aa!important; }
...
.factory, #scoring-board, .player-table  { filter: brightness(0.9); }
[style="--player-color: #0000ff;"] { --player-color: #6666ff !important; }
[style="--player-color: #ff0000;"] { --player-color: #ff3333 !important; }
[style="--player-color: #008000;"] { --player-color: #54aa54 !important; }
[style="--player-color: #ffa500;"] { --player-color: #ffc965 !important; }
`;
...
_darkStyleForGame['bayonetsandtomahawks'] = `
.settings_modal h2 { background-color: #123754; }
.settings_modal, #bt_tabbed_column { background-color: var(--dark-20); color: var(--light-80); }
.settings_modal #setting_modal_content .settings_modal_tabs .settings_modal_tab[data-state=selected] { background-color: var(--dark-20); }
.settings_modal #setting_modal_content .settings_modal_tabs .settings_modal_tab, #bt_tabbed_column .bt_tabbed_column_tab[data-state=inactive] { background-color: var(--dark-40); }
#clipboard_button svg, #battle_log_button .battle_log_icon, #information_button .information_modal_icon { fill: var(--light-50); }
#show_settings_menu:hover { color: #fff; }
#bt_cards_in_play, .bt_battle_info { background-color: var(--dark-20); }
.bt_unit_pool_container { background-color: var(--dark-30); }
#step_tracker li[data-active=true] { background-color: var(--dark-0); }
`;
...
_darkStyleForGame['bower'] = `
#overall-content { background-color: var(--dark-40); }
.tab_button, .player_hand_label { color: var(--light-80); }
.counter_shells { color: var(--light-50); }
`;
...
_darkStyleForGame['bunnydrops'] = `
#rounds { color: var(--light-80); }
.player_name { text-shadow: none; }
`;
...
_styleForGame['cakemaster'] = `
#bx-preference-container > div:first-child, #bx-preference-container > div:nth-child(2) { display: none; }
`;

_darkStyleForGame['cakemaster'] = `
.cm-area-player, .cm-area-player>span, #bx-preference-container, #cm-area-hand-container { background-color: var(--dark-back); }
.bx-pill { background-color: var(--dark-40); color: var(--light-80); }
.cm-area-player>span, #cm-area-hand-container .cm-cake-card-hand-share-container .cm-cake-share-player { text-shadow: none; }
.cm-area-player details summary, .cm-area-player details .cm-cake-history .cm-cake-history-round,
.cm-area-player details .cm-cake-history .cm-cake-history-tasty-score,
.cm-cake-container-wrap .cm-cake-container .cm-cake-tasty .cm-cake-tasty-score,
.cm-cake-share-player.bx-always-clickable { color: var(--light-80); text-shadow: none; }
.cm-area-player details .cm-cake-history { border-color: var(--dark-40); }
.bx-component-help { background-color: var(--blue-70); }
#cm-area-hand-container .cm-cake-card-hand-share-container { background-color: var(--dark-20) }
.bx-top-button-invalid:hover { color: var(--light-50)!important; }
#player_boards .cm-cake-container-wrap .cm-cake-container .cm-cake-quadrant { background-color: #0003; }
...
_darkStyleForGame['cassino'] = `
.card_1 { filter: brightness(0.9); }
`;
...
.cat_panel_prim_icons, #player_boards .cat_panel_prim_icons .cat_panel_score { filter: var(--drop-shadow-min) !important; }
...
html.darkpanel #player_boards .player-board.cat_activepl { background: var(--dark-40)!important; }
...
#cat_summary { filter: brightness(0.9); }
`;
...
_darkStyleForGame['coffee'] = `
#overall-content:before { content: ""; background: #00000060; position: absolute; width: 100%; height: 100%; }
.co_board { filter: drop-shadow(3px 2px 1px rgba(0, 0, 0, .8)) brightness(0.9); }
`;
...
.selectcard:before, .card:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%;  }
...
#relics, #dice-box { background-color: var(--dark-20); color: var(--light-80); }
`;
...
.ek_banner[style*="background-color: rgba(255, 255, 255, 0.6)"] { background-color: var(--dark-back)!important; color:var(--light-80); }
.ek_banner[style*="background-color: rgba(255, 255, 0, 0.8)"] { background-color: #666600cc !important; color: var(--light-80); }
.ek_popup_content { background-color: var(--dark-20); color: var(--light-80); }
`;
...
_darkStyleForGame['elpasogwt'] = `
#overall-content:before { content: ""; background: #00000060; position: absolute; width: 100%; height: 100%; }
.player_config_row svg { filter: invert(0.8); }
.player-board-name { padding: 0.3em 0.5em; background: none !important; }
#table .elpaso-gamezone { background: var(--dark-back); }
.bga-cards_deck-counter.round { background: var(--dark-10); box-shadow: 0 0 2px 1px var(--light-80); color: var(--light-80); }
#ELP_caution { background: var(--red-10); color: var(--light-80); }
#table-score-container #table-score-wrapper #table-score, #table-score-container #table-score-wrapper { background: var(--dark-20); color: var(--light-80); }
#table #main-board, #table #card-board, #table #worker-board, #table .elpaso-gamezone .gamezone-content { filter: brightness(0.9); }
`;
...
_darkStyleForGame['fiftyfirststate'] = `
.player-board .playerResourcesWrapper .playerResources { background-color: var(--dark-20); color: #000; }
#factionChooser { background: var(--dark-back); color: var(--light-80); }
.player-name [style="color: rgb(0, 0, 0);"] { text-shadow: var(--text-w-shadow); }
#deckConnectionsBlock, #hand, .factionBoard { background: var(--dark-back); color: var(--light-80); }
#hand #handSelector #unselected { background-color: var(--dark-40); }
#hand #handSelector .allBlock, #hand #handSelector .connectionsBlock, #hand #handSelector .locationsBlock { border-color: #000; }
#deckConnectionsBlock #collapseButton { filter: invert(1); }
.deals .resourceIcon, .logIcon { filter: var(--highlight-min); }
#toTop { background-color: var(--dark-20); color: var(--light-70); }
#toTop svg { fill: var(--light-70) !important; }
.resourceValue { color: #000; }
`;
...
_darkStyleForGame['flipseven'] = `
#overall-content:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%; top:0px; left: 0px; }
.f7-players-recap .f7_player-recap { background-color: var(--dark-back); }
.f7_player { background-color: var(--dark-back) !important; }
.f7_playerInfo .f7_container { color: var(--light-50); }
.f7_zoom_icon { filter: invert(0.8); }
`;
...
#bga-zoom-controls { filter: invert(0.8); }
.player-board .personal-objective-wrapper .arrow { filter: invert(0.8); }
.player-table .name { background: #000; height: 36px; left: 60px; top: 97px; width: 137px; }
.shape { filter: invert(1) hue-rotate(180deg) saturate(5); }
.shape[data-step="2"][data-shape="[0]"], .shape[data-step="3"][data-shape="[0,1]"], .shape[data-step="3"][data-shape="[0,2]"],
.shape[data-step="3"][data-shape="[0,0]"], .shape[data-step="4"][data-shape="[0,1,1]"], .shape[data-step="4"][data-shape="[0,2,2]"]
{ filter: invert(1) hue-rotate(180deg) saturate(5) var(--highlight-min); }
`;
...
_darkStyleForGame['indianchief'] = `
table#scoring_chart * { border-color: var(--light-50); color: var(--light-80); }
table#scoring_chart [style="color:black;"] { color: var(--light-80) !important; }
`;
...
_darkStyleForGame['kaiser'] = `
.playertable.declarer { background: #b8141466!important; }
.playertable.partner { background: #b8141433!important; }
.playertablename { text-shadow: none; }
[style="color:black"] { text-shadow: var(--text-w-shadow); }
#btnNoTrumpSelect { ${orangeButton} }
#btnNoTrumpSelect:hover { ${orangeButtonOver} }
.bgabutton_red { ${redButton} }
.bgabutton_red:hover { ${redButtonOver} }
`;

_darkStyleForGame['whist'] = _darkStyleForGame['kaiser'];
_darkStyleForGame['fivehundred'] = _darkStyleForGame['kaiser'];
...
_darkStyleForGame['kingoftokyoduel'] = `
#bga-zoom-wrapper #bga-zoom-controls { filter: var(--highlight); }
.difficulty-wrapper .difficulty { background: var(--dark-10); }
#stickers .sticker { background: var(--dark-20); color: var(--light-70); }
.icon.skull { filter: var(--highlight-min); }
.card, .monster-figure, .monster-board { filter: brightness(0.9); }
.monster-board .power { color: var(--light-70); }
.monster-board .power .power-description { background: var(--dark-20); }
.monster-board .power .power-name .outline { -webkit-text-stroke: 4px var(--dark-20); }
#stickers .sticker:not(.done) .sticker-name { background: #745861; }
#stickers .sticker .sticker-name { background: #ac204a; }
`;

_darkStyleForGame['kingscraft'] = `
...
button.switch, .check { background: var(--dark-10) !important }
`;
...
_darkStyleForGame['leaders'] = `
.player-board.blackPlayerZone .player-name a { color: #000!important; text-shadow: var(--text-w-shadow); }
...
div[id^=lvf_respanel_counter_kodama_] { color: #fff; }
`;

_darkStyleForGame['livingforestduel'] = `
html { background: #000; }
html.lfd_thematic_font_on .lfd_player, .player_board_inner .player-name a { text-shadow: #000000 2px 2px 4px; }
html.lfd_thematic_font_off .lfd_player { text-shadow: #000000 0 0 4px; }
.discussion_bubble.lfd_bubble.lfd_winterBubble { background-color: var(--dark-10); }
.player-board.lfd_winter .discussion_bubble:after { border-color: var(--dark-10) transparent !important; }
#page-title span.lfd_btnCounter.lfd_windResourceTypeCounter, .action-button span.lfd_btnCounter.lfd_windResourceTypeCounter { color: var(--light-80); }
#page-title .lfd_btnResource.lfd_btnWindResource { filter: invert(0.9) drop-shadow(-2px 2px 2px #00000091) !important; }
`;
...
body[data-myt_background_style="1"] #overall-content:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%; }
#player_config #turn_counter_wrapper, #myt_players_table .myt_player_table { background: var(--dark-back); }
...
.player_config_row > :not(#help-mode-switch) svg, #help-card .inline-icon.icon-slash, #help-card .inline-icon.icon-arrow { filter: invert(0.9); }
.nrd-card-container .nrd-card-inner, #trading .title, .accept, .reject, .numbered-icon[data-nb]:after { color: #000; }
...
_darkStyleForGame['paperworld'] = `
#overall-content:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%; top:0px; left: 0px; }
.pw_zone { background-color: var(--dark-back); }
.pw_tokenpreview { border: 1px solid var(--dark-10); }
`;
...
_darkStyleForGame['pioneerdaysproject'] = `
:root { --capacity-color: #80ff8a; }
.sum-used-capacity, .used-capacity { color: #66f; }
.character { color: #000; }
#button_undo { ${redButton} }
#button_undo:hover { ${redButtonOver} }
.dice { box-shadow: none; filter: var(--drop-shadow); }
#score table td.player-name { text-shadow: none; }
#score .score-row:nth-child(odd) { background: var(--dark-30); }
#score .score-row:nth-child(2n) { background: var(--dark-20); }
#score th { background-color: var(--dark-10); }
#score table td:not(:first-child) { text-shadow: none; color: var(--light-80); }
#score * { border-color: var(--light-50) !important; }
#table { background: var(--dark-30); }
`;
...
.res_resource_gold .res_counterintext  { color: #000; }
...
.se_zoom_icon { filter: invert(0.8); }
.se_player_name .ml-6 { color: var(--light-80)!important; }
.se_count { color: #000; }
.se_token_seedy .sprite-seedy-f { filter: var(--drop-shadow); }
...
_darkStyleForGame['symbiose'] = `
#overall-content:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%; }
.nameplayer, .nameplayer_mini_1_3, .nameplayer_mini_1_4, .nameplayer_mini_3_3, .nameplayer_mini_2_4, .nameplayer_mini_3_4, nameplayer_mini_2_2,
.nameplayer_mini_2_2_duel, .nameplayer_mini_2_2_duel_2, .river, .river2 { background-color: var(--dark-back); }
[style*="border-top: 2px solid #0000ff;"] { border-color: #6565ff !important; }
...
_darkStyleForGame['thewhitecastle'] = `
html:not(.no-custom-background) #overall-content:before { content: ""; background: #00000080; position: absolute; width: 100%; height: 100%; }
#twc-draft-area { background-color: var(--dark-back); }
.twc-actions-tooltip .twc-actions-tooltip-action-block[data-type=light] { background-color: var(--dark-40); }
#twc-main-game-panel img, #popin_twcHelpDialog, #popin_twcHelpDialog > *, #popin_twcHelpDialog_title img { filter: invert(1); }
#jj-preferences-panel #jj-preferences-panel-content .jj-preferences-panel-category-label { background: var(--dark-back); }
#popin_twcHelpDialog #popin_twcHelpDialog_contents { background-color: var(--dark-back); color: var(--light-80); }
#popin_twcHelpDialog { border-color: #fff; }
#popin_twcHelpDialog_title { color: var(--light-80); }
.twc-icon-art.game-log { filter: var(--highlight-min); }
...
_darkStyleForGame['thousand'] = `
.playertable.declarer { background: #08450899!important; }
.playertablename { text-shadow: none; }
[style^="color:black"] { text-shadow: var(--text-w-shadow); }
`;
...
_darkStyleForGame['welcometothemoon'] = `
#welcometo-container #plan-cards-container, #welcometo-container #construction-cards-container, .score-sheet-wrapper .score-sheet-holder .score-sheet .player-name { background-color: var(--dark-back); }
.wttm-player-panel .numbers-status, .log-number, .card-number { color: #000; }
#player_config .player_config_row#scenario-name { background: var(--dark-0); border-color: var(--dark-40); }
.score-sheet-wrapper .score-sheet-holder .score-sheet, .construction-card-holder .construction-card-back { filter: brightness(0.9); }
#popin_chooseNumber,#popin_showOverview,#popin_showSettings { background-color: var(--dark-20); color: var(--light-80) }
#popin_showOverview #popin_showOverview_contents table tbody tr:nth-of-type(odd) { background-color: var(--dark-40); }
#popin_showOverview #popin_showOverview_contents table tbody tr td span.details, #popin_showOverview #popin_showOverview_contents table tbody tr td i { color: var(--light-50); }
#btnUndoLastStep { ${orangeButton} }
#btnUndoLastStep:hover { ${orangeButtonOver} }
#btnRestartTurn { ${redButton} }
#btnRestartTurn:hover { ${redButtonOver} }
`;
...
_darkStyleForGame['wolfandsheeps'] = `
body { color: var(--light-80); }
.wsh_playername_wrapper_000000, .wsh_playername_wrapper_000000 .playername { background-color: transparent!important; text-shadow: var(--text-w-shadow); }
.wsh_playername_wrapper_ffffff, .wsh_playername_wrapper_ffffff .playername { background-color: transparent!important; text-shadow: none; }
`;
...
.bgabutton_blue[style="background-color: rgb(255, 177, 30); color: rgb(0, 0, 0); text-shadow: none;"] { ${orangeButton} }
.notouch-device .bgabutton_blue[style="background-color: rgb(255, 177, 30); color: rgb(0, 0, 0); text-shadow: none;"]:not(disabled):hover { ${orangeButtonOver} }
