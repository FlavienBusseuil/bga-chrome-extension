...
const Options = (props: { config: Configuration }) => {
  ...
  const getHiddenConfiguration = () => {
    return (
      <>
        <div className="bgext_options_title">{chrome.i18n.getMessage('optionHiddenTitle')}</div>
  ...
  const getNavigationConfiguration = () => {
    return (
      <>
        <div className="bgext_options_title">{chrome.i18n.getMessage('optionNavigationTitle')}</div>
    ...
    <div className="bgext_options_main">
      <div className="bgext_options_config_area">
        <div className="bgext_links_area">
          <div className={tabSelected === 'hidden' ? "bgext_link_selected" : "bgext_link"} href="#" selected={tabSelected === 'hidden'} onClick={() => setTabSelected('hidden')}>
            {chrome.i18n.getMessage('optionHiddenTab')}
          </div>
          <div className={tabSelected === 'navigation' ? "bgext_link_selected" : "bgext_link"} href="#" selected={tabSelected === 'navigation'} onClick={() => setTabSelected('navigation')}>
